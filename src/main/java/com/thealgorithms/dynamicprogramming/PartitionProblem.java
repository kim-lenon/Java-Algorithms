...
/**
 * The partition problem is a classic problem in computer science that asks
 ...
 * <pre>
 * nums = {1, 2, 3}
 * We can split the array "nums" into two partitions, each with a sum of 3:
 *   nums1 = {1, 2}
 *   nums2 = {3}
 * </pre>
 *
 * <p>Time complexity: O(n × sum), Space complexity: O(n × sum)
 *
